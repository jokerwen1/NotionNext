...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JokerWen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'CV工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'wenhao.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术风险, 生活分享', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jokerwem11@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/JokerWen110', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/jokerwen1', // 你的github个人主页 例如 https://github.com/tangly1024
  // 网站字体
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备18005889号', // 备案号 闽ICP备XXXXXXX
